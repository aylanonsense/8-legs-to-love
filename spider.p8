...
-- +10 score text when eating bug
-- spider can only fall off map when not in hitstun
-- spider respawns on map
-- halloween map
...
function create_fly(x,y)
	create_bug(x,y,"fly",{64},{12,13,5,1})
end

function create_firefly(x,y)
	create_bug(x,y,"firefly",{80},{9,4,2,1})
end

function create_dragonfly(x,y)
	create_bug(x,y,"dragonfly",{96},{11,3,5,1})
end

function create_hornet(x,y)
	create_bug(x,y,"hornet",{112},{10,15,4,1})
end

function create_beetle(x,y)
	create_bug(x,y,"beetle",{71},{8,13,5,1})
end

function create_bug(x,y,species,sprites,colors)
	local bug={
		["species"]=species,
		["x"]=x,
		["y"]=y,
...

